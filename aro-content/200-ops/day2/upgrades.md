...
1. Return to your tab with the OpenShift Web Console. If you need to reauthenticate, follow the steps in the [Access Your Cluster](../../100-setup/3-access-cluster.md/) section.
